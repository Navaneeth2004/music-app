...
export const SoloFlashcardFormScreen: React.FC<Props> = ({ deck, editCard, onSave, onBack }) => {
    ...
    <SafeAreaView style={s.safe}>
      ...
      <View style={s.header}>
        ...
        <View style={[s.deckBadge, { backgroundColor: deck.color + '22' }]}>
          ...
          <Text style={[s.deckBadgeText, { color: deck.color }]}>{deck.title}</Text>
        </View>
...
const s = StyleSheet.create({
  ...
  deckBadge:       { flex: 1, flexDirection: 'row', alignItems: 'center', gap: Spacing.xs, borderRadius: 999, paddingHorizontal: Spacing.sm, paddingVertical: 4, justifyContent: 'center' },
  deckBadgeText:   { fontSize: FontSize.sm, fontWeight: '700' },
